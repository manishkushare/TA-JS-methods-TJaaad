...
console.log("slice from index 5 :",fruits.slice(5));
...
console.log("to lower case :",fruits.join().toLowerCase().split(","));
...
console.log("numbers array :", numbers.flat(1));
// Convert the numbersTwo array to one level element. Remove all sub-arrays to individual elements and log them.
console.log("numbersTwo array :", numbersTwo.flat(2));
...
newFlatArray = numbersThree.flat(Infinity);
...
console.log("index of 10 :", numbersThree.flat(Infinity).findIndex(num => {
    return num === 10;
}))

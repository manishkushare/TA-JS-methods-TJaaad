...
console.log("add 3 :", addThreeToArray([1,2,3,4],addThree));
...
console.log("add 5 :", addFiveToArray([1,2,3,4],addFive));
...
console.log("2 :",changeArray([1, 2, 3, 4, 5, 6], addTwo)); // [3, 4, 5, 6, 7, 8]
console.log("3 :",changeArray([1, 2, 3, 4, 5, 6], addThree)); // [4, 5, 6, 7, 8, 9]
console.log("5 :",changeArray([1, 2, 3, 4, 5, 6], addFive)); // [6, 7, 8, 9, 10, 11]
...
console.log("callMe :",callMe(function(){
  return 2+1;
}));
...
console.log("isMale:",isMale(grades[0])); // true
console.log("isMale:",isMale(grades[1])); // false
console.log("isMale:",isMale(grades[2])); // true
/*
...
console.log("isFemale :",isFemale(grades[0])); // false
console.log("isFemale :",isFemale(grades[1])); // true
console.log("isFemale :",isFemale(grades[2])); // false
...
console.log("isGradeA :",isGradeA(grades[0])); // false
console.log("isGradeA :",isGradeA(grades[1])); // false
console.log("isGradeA :",isGradeA(grades[2])); // true
...
console.log("isGradeB :",isGradeB(grades[0])); // true
console.log("isGradeB :",isGradeB(grades[1])); // true
console.log("isGradeB :",isGradeB(grades[2])); // false
/*
...
console.log("isGradeC :",isGradeC(grades[0])); // true
console.log("isGradeC :",isGradeC(grades[1])); // false
console.log("isGradeC :",isGradeC(grades[2])); // false
/*
...
console.log("filterAdult :",filterAdult(people));
...
console.log("filterMale :",filterMale(grades));
...
function filterFemale(arr){
  let newArray = [];
  for(let females of arr){
    if(females.sex === "F"){
      newArray.push(females);
    }
  }
  return newArray;
}
console.log("filterFemale :",filterFemale(grades));
...
console.log("filterGradeA :",filterGradeA(grades));
...
console.log("filterGradeB :",filterGradeB(grades));
/*
...
console.log("filterGradeC :",filterGradeC(grades));
/*
